...
async function identifySlots(geometry, opts = {}) {
  ...
  const canonical = canonicalizeSlotMap(map, geometry);
  return {
...
module.exports = { identifySlots, SLOT_ID_MODEL, _internals: { buildOutline, firstTextBlock, stripFence, canonicalizeSlotMap, textAtLocation, canonicalSlotId } };
